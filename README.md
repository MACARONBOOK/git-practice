...
20220725<br>
Team MSEK recover files(fix errors, layout), start to edit layout<br>

20220726<br>
Team MSEK checked errors by test-sheet, try to fix errors other-cases<br>

20220727<br>
Team MSEK edit detailed layout(aligned the edge & value-of-table), little-error(how to delete many-images on one-item)<br>

20220728<br>
TEAM MSEK finished application Nagano_cake, feddback other 3group's app<br>
created presentation(slide & movie), push to main-branch(origin)<br>

20220729<br>
create new repository Cranberry(preparation ok), but another repository BerryBitterSweets got cardinal errors(fail at the prepation-stage like MCVR)<br>

20220730<br>
feedback for Team MSEK, check portfolio's curriculum how to start lesson<br>

20220731<br>
create new repository okazu_recipe for port's README<br>
create each-them(ER, table-sheet, portfolio-function-sheet)<br>
